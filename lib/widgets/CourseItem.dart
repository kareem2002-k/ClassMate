          ...
          Padding(
            ...
            child: Container(
              ...
              child: IconButton(
                color: Colors.black,
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => CourseInfo(courseName: courseName, courseCode: courseCode,))); // TODO: may need to replace this with routing
